...
def plotwith7inputfiles(Index1, Index2,Index3,Index4, Index5, Index6, Index7, Thread1, Thread2, Thread3, Thread4,
    ...
    while i < k :#numberofdifferentindicies3 :
        ...
        #plt.errorbar(Thread2Dummy, Time2Dummy, Deviation2Dummy, linestyle='None', fmt='^', label ='This is the plot of function ' + j)#, 
            #color='black', ecolor='gray')   
        plt.plot(Thread2Dummy, Time2Dummy, label = "PSPSO")#, label = "Papso non Blocking")#, label = 'Function with index ' + j)
        i += 1
...
#you need to manually adjust the legend
def plotfitnesswith7inputfiles(Index1, Index2,Index3,Index4, Index5, Index6, Index7, Thread1, Thread2, Thread3, Thread4,
        Thread5, Thread6, Thread7, Time1, Time2, Time3, Time4, Time5, Time6, Time7, Deviation1, Deviation2, 
        Deviation3, Deviation4, Deviation5, Deviation6, Deviation7, BestFitnessValue1, BestFitnessValue2, 
        BestFitnessValue3, BestFitnessValue4, BestFitnessValue5, BestFitnessValue6, BestFitnessValue7,
        storagelocation , titleoftheplot, startindex, endindex, xl='Threads', yl = 'Times'):
    #I will create a seperate plot for every index and put them together in the end
    #print("Currently plotting")
    plt.cla()
    ...
    #plt.legend( handles = [Median_Plot, Deviations_Plot]) # can add more names to the legend now
    while i < k :#numberofdifferentindicies1:
        IndexDummy = Index1[i:(i + 1)]
        Time2Dummy = IndexDummy[0]
        ThreadDummy = Thread1[i:(i+ 1)]
        DeviationDummy = Deviation1[i:(i + 1)] #used this silly work arround
        TimeDummy = Time1[i:(i + 1)]
        Time2Dummy = TimeDummy[0]
        Thread2Dummy = ThreadDummy[0]
        Deviation2Dummy = DeviationDummy[0]
        FitnessDummy = BestFitnessValue1[i:(i + 1)]
        Fitness2Dummy = FitnessDummy[0]
        j = str(i)
        #plt.errorbar(Thread2Dummy, Time2Dummy, Deviation2Dummy, linestyle='None', fmt='o',  label ='This is the plot of function ' + j)#, 
            #color='black', ecolor='gray')   
        #plt.plot(Thread2Dummy, Time2Dummy)#, label = 'Function with index ' + j)
        #plt.plot(Thread2Dummy, Time2Dummy, label = "Pspso")
        plt.plot(Thread2Dummy, Fitness2Dummy, label = "PAPSO")
        i += 1

    i = int(startindex)
    k = int(endindex)
    while i < k :#numberofdifferentindicies2 :
        IndexDummy = Index2[i:(i + 1)]
        Time2Dummy = IndexDummy[0]
        ThreadDummy = Thread2[i:(i+ 1)]
        DeviationDummy = Deviation2[i:(i + 1)] #used this silly work arround
        TimeDummy = Time2[i:(i + 1)]
        ...
        FitnessDummy = BestFitnessValue2[i:(i + 1)]
        Fitness2Dummy = FitnessDummy[0]
        ...
        nFitness2Dummy = np.full((tmp_thread_size), tmp_fitness)
        ...
        #x = lambda a : functionvalue
        #valuerange = np.linspace(0, 50, 200)
        plt.plot(nThread2Dummy, nTime2Dummy, label = "PSO")#, label = 'Function with index ' + j)
        #plt.errorbar(Thread2Dummy, Time2Dummy, Deviation2Dummy, linestyle='None', fmt='x', label ='This is the plot of function ' + j)#, 
            #color='black', ecolor='gray')   
        #plt.plot(Thread2Dummy, Time2Dummy, label = "Papso Pre ")#, label = 'Function with index ' + j)
        plt.plot(Thread2Dummy, Fitness2Dummy)
        i += 1
    
    i = int(startindex)
    k = int(endindex)
    while i < k :#numberofdifferentindicies3 :
        IndexDummy = Index3[i:(i + 1)]
        Time2Dummy = IndexDummy[0]
        ThreadDummy = Thread3[i:(i+ 1)]
        DeviationDummy = Deviation3[i:(i + 1)] #used this silly work arround
        TimeDummy = Time3[i:(i + 1)]
        ...
        Thread2Dummy = ThreadDummy[0]
        Deviation2Dummy = DeviationDummy[0]
        FitnessDummy = BestFitnessValue3[i:(i + 1)]
        Fitness2Dummy = FitnessDummy[0]
        j = str(i)
        #plt.errorbar(Thread2Dummy, Time2Dummy, Deviation2Dummy, linestyle='None', fmt='^', label ='This is the plot of function ' + j)#, 
            #color='black', ecolor='gray')   
        #plt.plot(Thread2Dummy, Time2Dummy)#, label = "Papso non Blocking")#, label = 'Function with index ' + j)
        plt.plot(Thread2Dummy, Fitness2Dummy, label ="PSPSO")
        i += 1

    i = int(startindex)
    k = int(endindex)
    while i < k :#numberofdifferentindicies4 :
        IndexDummy = Index4[i:(i + 1)]
        Time2Dummy = IndexDummy[0]
        ThreadDummy = Thread4[i:(i+ 1)]
        DeviationDummy = Deviation4[i:(i + 1)] #used this silly work arround
        TimeDummy = Time4[i:(i + 1)]
        ...
        Thread2Dummy = ThreadDummy[0]
        Deviation2Dummy = DeviationDummy[0]
        FitnessDummy = BestFitnessValue4[i:(i + 1)]
        Fitness2Dummy = FitnessDummy[0]
        j = str(i)
        #plt.errorbar(Thread2Dummy, Time2Dummy, Deviation2Dummy, linestyle='None', fmt='H', label ='This is the plot of function ' + j)#, 
            #color='black', ecolor='gray')   
    ...
    while i < k :#numberofdifferentindicies5 :
        ...
        Time2Dummy = TimeDummy[0]
        Thread2Dummy = ThreadDummy[0]
        FitnessDummy = BestFitnessValue5[i:(i + 1)]
        Fitness2Dummy = FitnessDummy[0]
        Deviation2Dummy = DeviationDummy[0]
        j = str(i)
        #plt.errorbar(Thread2Dummy, Time2Dummy, Deviation2Dummy, linestyle='None', fmt='s', label ='This is the plot of function ' + j)#, 
    ...
    k = int(endindex)
    while i < k :#numberofdifferentindicies6 :
        IndexDummy = Index6[i:(i + 1)]
        Time2Dummy = IndexDummy[0]
        ThreadDummy = Thread6[i:(i+ 1)]
        DeviationDummy = Deviation6[i:(i + 1)] #used this silly work arround
        TimeDummy = Time6[i:(i + 1)]
        Time2Dummy = TimeDummy[0]
        FitnessDummy = BestFitnessValue6[i:(i + 1)]
        Fitness2Dummy = FitnessDummy[0]
        Thread2Dummy = ThreadDummy[0]
        Deviation2Dummy = DeviationDummy[0]
        #print(Thread2Dummy)
        ...
        #x = lambda a : functionvalue
        #valuerange = np.linspace(0, 50, 200)
        #plt.plot(Thread2Dummy, Time2Dummy)#, label = "PSO")#, label = 'Function with index ' + j)            plt.plot(Thread2Dummy, Fitness2Dummy)
        #plt.plot(Thread2Dummy, Fitness2Dummy)
    ...
    while i < k :#numberofdifferentindicies :
        ...
        Time2Dummy = TimeDummy[0]
        Thread2Dummy = ThreadDummy[0]
        FitnessDummy = BestFitnessValue7[i:(i + 1)]
        Fitness2Dummy = FitnessDummy[0]
        Deviation2Dummy = DeviationDummy[0]
        j = str(i)
        #plt.errorbar(Thread2Dummy, Time2Dummy, Deviation2Dummy, linestyle='None', fmt='2', label ='This is the plot of function ' + j)#, 
...
def main():
    ...
    if placetogo == 1:
        ...
        plotfitnesswith7inputfiles( 
            PlottingIndex1, PlottingIndex2, PlottingIndex3, PlottingIndex4, PlottingIndex5, PlottingIndex6, PlottingIndex7, 
            PlottingThread1, PlottingThread2, PlottingThread3, PlottingThread4, PlottingThread5, PlottingThread6, PlottingThread7, 
            PlottingTime1, PlottingTime2, PlottingTime3, PlottingTime4, PlottingTime5, PlottingTime6, PlottingTime7, 
            PlottingDeviation1, PlottingDeviation2, PlottingDeviation1, PlottingDeviation4, PlottingDeviation5, PlottingDeviation6, 
            PlottingDeviation7,
            PlottingBestFitnessValue1,  PlottingBestFitnessValue2, PlottingBestFitnessValue3, PlottingBestFitnessValue4, PlottingBestFitnessValue5, 
            PlottingBestFitnessValue6, PlottingBestFitnessValue7, storagelocation, titleofplot, startindex, endindex, xlabel, ylabel)


#def plotfitneswith7inputfiles(Index1, Index2,Index3,Index4, Index5, Index6, Index7, Thread1, Thread2, Thread3, Thread4,
#        Thread5, Thread6, Thread7, Time1, Time2, Time3, Time4, Time5, Time6, Time7, Deviation1, Deviation2, 
#        Deviation3, Deviation4, Deviation5, Deviation6, Deviation7, BestFitnessValue1, BestFitnessValue2, 
#        BestFitnessValue3, BestFitnessValue4, BestFitnessValue5, BestFitnessValue6, BestFitnessValue7,
#         storagelocation , titleoftheplot, startindex, endindex, xl='Threads', yl = 'Times'):
