...
def fillupp(Index, Thread, Time, Bestfitnessvalue):
    ...
    print(len(newIndex))
    print(len(Index))
    ThreadId = DistinctElements(Thread)
    print(ThreadId)
    i = 0
    j = 0
    k1 = 0
    ...
    while k1 < len(Index): #and k2 < expectedsize:
        while i < numberofdifferentindicies:
            while j < numberofdifferentthreads:
                if Index[k1] == i and ThreadId[k1] == j:
        ...
        while i < numberofdifferentindicies:
            ...
            if numberofcurrentdata < 50:
                ...
                for m in range(0,l):
                    ...
                    print(k1)
                    print(k2)
                    newIndex[k2] = Index[kold -m]
                    newTime[k2] = Time[kold- m]
                    newThread[k2] = Thread[kold- m]
                    newBestFV[k2] = Bestfitnessvalue[kold- m]
...
def main():
    ...
    """
    chef ='times_pspso_o3_march.dat'
    nameoffile = chef #input("What is the location of your file! ")
    #preclean(nameoffile)
