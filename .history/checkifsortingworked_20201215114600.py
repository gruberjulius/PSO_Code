...
def storeData(PlottingIndex, PlottingThread, PlottingDeviation, 
            PlottingBestFitnessValue, storagelocation):
    print('Hi', file=open(storagelocation, 'a'))
    print('Hello from AskPython', file=open(storagelocation, 'a'))
    print('exit', file=open(storagelocation, 'a'))
...
def main():
    ...
    storagelocation = "example.txt"
    storeData(PlottingIndex, PlottingThread, PlottingDeviation, 
            PlottingBestFitnessValue, storagelocation)
