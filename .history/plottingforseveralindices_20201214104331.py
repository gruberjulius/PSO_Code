...
def hmean(arr):
    modarr = 1./arr #invert the array elements
    lenarr = len(modarr) # get the length of the array
...
def preperationwithdifferentindices(numberofdifferentfunctions, Index, Threads, Time, BestFitnessValue)
    """
...
def main():
    ...
    preperationwithdifferentindices(numberofdifferentfunctions, Index, Threads, Time, BestFitnessValue)
