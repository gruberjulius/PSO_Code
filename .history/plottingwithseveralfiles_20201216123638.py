...
def plotwith2inputfiles( Index1, Index2, Thread1, Thread2, Time1, Time2, Deviation1, Deviation2, storagelocation , 
        titleoftheplot, startindex , numberoffunctionstoplot,  xl='Threads', yl = 'Times'):
    #I will create a seperate plot for every index and put them together in the end
    print("Currently plotting")
    plt.cla()
    plt.figure(figsize=(12,6)) # function to scale the plot how you want it
    ...
    i = startindex
    #print(len(np.unique(Index)))
    #numberofdifferentindicies1 = len(np.unique(Index1))
    #numberofdifferentindicies2 = len(np.unique(Index2))
    #ThreadDummy = Thread[i:(i+ 1)]
    #TimeDummy = Time[i:(i + 1)]
    #DeviationDummy = Deviation[i:(i + 1)]
    #print(ThreadDummy)
    ...
    #plt.legend( handles = [Median_Plot, Deviations_Plot]) # can add more names to the legend now
    #print("a")
    while i < numberoffunctionstoplot + startindex:#numberofdifferentindicies1:
        #print("b")
        ...
        i += 1
    i = 2
    while i < numberoffunctionstoplot + startindex :#numberofdifferentindicies2 :
        #print("b" )
...
def main():
    ...
    if placetogo == 1:
        ...
        titleofplot = input("What is the title of the plot? ") 
        startindex = input("What is the starting index of the functions you want to plot: ")
        numberoffunctions = int(input("what is the number of functions U use? "))
        xlabel = input("how do you want to label your x axes: ")
        ylabel = input("how do you want to label your y axes: 0")
        plotwith2inputfiles(PlottingIndex1, PlottingIndex2, PlottingThread1, PlottingThread2, PlottingTime1, PlottingTime2, 
            PlottingDeviation1, PlottingDeviation2, titleofplot, titleofplot, startindex, numberoffunctions, xlabel, ylabel )
    elif placetogo == 3:
        nameoffile1 = input("What is the name of your file 1? ")
        nameoffile2 = input("What is the name of your file 2? ")
