...
def main():
    ...
    I excpect that the data set has the following form:
    1. first index of the function
    2. The number of threads used in the current timestep
    3. the different outcomes for the time measuremtn 
    ...
    if(numberofdifferentIndicies == 1):
        ...
        preperationwithdifferentindices(numberofdifferentIndicies, Index, Threads, Time, BestFitnessValue, stepsize)
