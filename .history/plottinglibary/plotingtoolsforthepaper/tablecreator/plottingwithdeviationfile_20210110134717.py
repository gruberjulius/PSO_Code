    ...
    while j < numberofdatasets:
            ...
            if constant =="y":
                ...
                while i < k :#numberofdifferentindicies
                    ...
                    #ListofDeviations.append(Deviation2Dummy)
                
                    for i in range (len(Deviation2Dummy)):
                        print(Deviation2Dummy[i], end = ', ')
                        if i%5 == 1:
                            print("\n")
                        #print(",")
                    ...
                    Time2Dummy = TimeDummy[0]
                    Thread2Dummy = ThreadDummy[0]
                    #plt.errorbar(Thread2Dummy, Time2Dummy, Deviation2Dummy, label = labelname, fmt='o')#, linestyle='None', fmt='o',  label = labelname)
                    i += 1
            j += 1
    
    #print("d")
    #print(sum(ListofDeviations))
    #print(len(ListofDeviations))
    #statistics.mean(ListofDeviations)
