...
def plottingwithdeviation(Datasets):
    ...
    while j < numberofdatasets:
            ...
            if constant =="y":
                ...
                tmp_thread_size = 33
                nTime2Dummy = np.full((tmp_thread_size), tmp_time)1
                ...
                while i < k :#numberofdifferentindicies
                    ...
                    Time2Dummy = TimeDummy[0]
                    Thread2Dummy = ThreadDummy[0]
                    plt.errorbar(Thread2Dummy, Time2Dummy, Deviation2Dummy, label = labelname, fmt='d', elinewidth=1.5, capsize=3, capthick=3)
