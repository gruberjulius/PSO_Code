    ...
    while j < numberofdatasets:
            ...
            if constant =="y":
                ...
                while i < k :#numberofdifferentindicies
                    ...
                    Time2Dummy = TimeDummy[0]
                    Thread2Dummy = ThreadDummy[0]
                    plt.errorbar(Thread2Dummy, Time2Dummy, Deviation2Dummy, label = labelname, fmt='o', uplims=upperlimit, lolims = lowerlimits)#, barsabove = 'True')#, uplims=True, lolims=True)#, linestyle='None', fmt='o',  label = labelname)
                    i += 1
            j += 1
