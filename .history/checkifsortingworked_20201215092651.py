...
def Prepare(Index, Thread, Time, BestFitnessValue):
    ...
    ConvertDatahmean(Time, PlottingTime, Samplesize)
    ConvertDatahmean(BestFitnessValue, PlottingBestFitnessValue, Samplesize)

    Index = PlottingIndex.deepcopy()
    Thread = PlottingThread.deepcopy()
    Time = PlottingTime.deepcopy()
    BestFitnessValue = PlottingBestFitnessValue.deepcopy()
    return PlottingDeviation
