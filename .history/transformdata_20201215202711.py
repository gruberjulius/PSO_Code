...
def fillupp(Index, Thread, Time, Bestfitnessvalue):
    ...
    newIndex = np.array(numberofdifferentindicies * numberofdifferentthreads)
    newThread = np.array(numberofdifferentindicies * numberofdifferentthreads)
    newTime = np.array(numberofdifferentindicies * numberofdifferentthreads)
    newBestFV = np.array(numberofdifferentindicies * numberofdifferentthreads)
