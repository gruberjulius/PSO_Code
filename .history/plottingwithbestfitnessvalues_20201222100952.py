...
#            PlottingTime1, PlottingTime2, PlottingTime3, PlottingTime4, PlottingTime5, PlottingTime6, PlottingTime7, Deviations1, Deviations2, Deviations3, Deviations4, 
#            Deviations4, Deviations5,Deviations6, Deviations7, PlottingBestFitnessValue1, PlottingBestFitnessValue2, PlottingBestFitnessValue3, PlottingBestFitnessValue4, PlottingBestFitnessValue5, PlottingBestFitnessValue6, 
...
def plotwith7inputfiles(Index1, Index2,Index3,Index4, Index5, Index6, Index7, Thread1, Thread2, Thread3, Thread4,
        ...
        Deviation3, Deviation4, Deviation5, Deviation6, Deviation7, BestFitnessValue1, BestFitnessValue2, oBestFitnessValue3,
        BestFitnessValue4, BestFitnessValue5, BestFitnessValue6, BestFitnessValue7, storagelocation , titleoftheplot, 
        startindex, endindex, xl='Threads', yl = 'Times'):
    #I will create a seperate plot for every index and put them together in the end
    #print("Currently plotting")
    plt.cla()
    plt.figure(figsize=(12,6)) # function to scale the plot how you want it
    #plt.axis([10, 33, 0, 10]) # manually scale the plotting
    plt.title(titleoftheplot)
    plt.grid(linewidth = "1", b=True, which='both', alpha=1)
    plt.xlabel(xl)
    plt.ylabel(yl, rotation=0) 
    ...
    while i < k :#numberofdifferentindicies1:
        ...
        DeviationDummy = Deviation1[i:(i + 1)] #used this silly work arround
        TimeDummy = Time1[i:(i + 1)]
        BestFitnessDummy = BestFitnessValue1[i:(i + 1)]
        BestFitness2Dummy = BestFitnessDummy[0]
        Time2Dummy = TimeDummy[0]
        Thread2Dummy = ThreadDummy[0]
        Deviation2Dummy = DeviationDummy[0]
        j = str(i)
        #plt.errorbar(Thread2Dummy, Time2Dummy, Deviation2Dummy, linestyle='None', fmt='o',  label ='This is the plot of function ' + j)#, 
            #color='black', ecolor='gray')   
        plt.plot(Thread2Dummy, Time2Dummy)#, label = 'Function with index ' + j)
        #plt.plot(Thread2Dummy, Time2Dummy, label = "Pspso")
        i += 1
    ...
    while i < k :#numberofdifferentindicies2 :
        ...
        TimeDummy = Time2[i:(i + 1)]
        Time2Dummy = TimeDummy[0]
        BestFitnessDummy = BestFitnessValue2[i:(i + 1)]
        BestFitness2Dummy = BestFitnessDummy[0]
        Thread2Dummy = ThreadDummy[0]
        Deviation2Dummy = DeviationDummy[0]
        j = str(i)
        #plt.errorbar(Thread2Dummy, Time2Dummy, Deviation2Dummy, linestyle='None', fmt='x', label ='This is the plot of function ' + j)#, 
            #color='black', ecolor='gray')   
        plt.plot(Thread2Dummy, Time2Dummy, label = "Papso Pre ")#, label = 'Function with index ' + j)
        i += 1
    ...
    while i < k :#numberofdifferentindicies3 :
        ...
        TimeDummy = Time3[i:(i + 1)]
        Time2Dummy = TimeDummy[0]
        BestFitnessDummy = BestFitnessValue3[i:(i + 1)]
        BestFitness2Dummy = BestFitnessDummy[0]
        Thread2Dummy = ThreadDummy[0]
        Deviation2Dummy = DeviationDummy[0]
        j = str(i)
        #plt.errorbar(Thread2Dummy, Time2Dummy, Deviation2Dummy, linestyle='None', fmt='^', label ='This is the plot of function ' + j)#, 
            #color='black', ecolor='gray')   
        plt.plot(Thread2Dummy, Time2Dummy)#, label = "Papso non Blocking")#, label = 'Function with index ' + j)
        i += 1
    ...
    while i < k :#numberofdifferentindicies4 :
        ...
        Time2Dummy = TimeDummy[0]
        BestFitnessDummy = BestFitnessValue4[i:(i + 1)]
        BestFitness2Dummy = BestFitnessDummy[0]
        Thread2Dummy = ThreadDummy[0]
        Deviation2Dummy = DeviationDummy[0]
        j = str(i)
        #plt.errorbar(Thread2Dummy, Time2Dummy, Deviation2Dummy, linestyle='None', fmt='H', label ='This is the plot of function ' + j)#, 
            #color='black', ecolor='gray')   
        plt.plot(Thread2Dummy, Time2Dummy,)# label = "Papso Send")#, label = 'Function with index ' + j)
        i += 1    
    ...
    while i < k :#numberofdifferentindicies5 :
        ...
        Time2Dummy = TimeDummy[0]
        BestFitnessDummy = BestFitnessValue5[i:(i + 1)]
        BestFitness2Dummy = BestFitnessDummy[0]
        Thread2Dummy = ThreadDummy[0]
        Deviation2Dummy = DeviationDummy[0]
        j = str(i)
        #plt.errorbar(Thread2Dummy, Time2Dummy, Deviation2Dummy, linestyle='None', fmt='s', label ='This is the plot of function ' + j)#, 
            #color='black', ecolor='gray')   
        plt.plot(Thread2Dummy, Time2Dummy)#, label = "Papso Smaller Packages")#, label = 'Function with index ' + j)
        i += 1
    ...
    while i < k :#numberofdifferentindicies6 :
        ...
        Time2Dummy = TimeDummy[0]
        BestFitnessDummy = BestFitnessValue6[i:(i + 1)]
        BestFitness2Dummy = BestFitnessDummy[0]
        Thread2Dummy = ThreadDummy[0]
        Deviation2Dummy = DeviationDummy[0]
        #print(Thread2Dummy)
        ...
        #plt.errorbar(Thread2Dummy, Time2Dummy, Deviation2Dummy, linestyle='None', fmt='D', label ='This is the plot of function ' + j)#, 
            #color='black', ecolor='gray') 
        #functionvalue = Time2Dummy[0]  
        #x = lambda a : functionvalue
        #valuerange = np.linspace(0, 50, 200)
        plt.plot(Thread2Dummy, Time2Dummy)#, label = "PSO")#, label = 'Function with index ' + j)
        i += 1
    ...
    while i < k :#numberofdifferentindicies6 :
        ...
        Time2Dummy = TimeDummy[0]
        Thread2Dummy = ThreadDummy[0]
        BestFitnessDummy = BestFitnessValue7[i:(i + 1)]
        BestFitness2Dummy = BestFitnessDummy[0]
        Deviation2Dummy = DeviationDummy[0]
        j = str(i)
        #plt.errorbar(Thread2Dummy, Time2Dummy, Deviation2Dummy, linestyle='None', fmt='2', label ='This is the plot of function ' + j)#, 
            #color='black', ecolor='gray')   
        plt.plot(Thread2Dummy, Time2Dummy)#, label = "Papso")#, label = 'Function with index ' + j)
        i += 1  
...
def main():
    ...
    if placetogo == 1:
        ...
        Index1, Thread1, Time1 , BestFitnessValue1 = np.loadtxt( nameoffile1 , delimiter=' ', unpack=True)
        Index2, Thread2, Time2 , BestFitnessValue2 = np.loadtxt( nameoffile2 , delimiter=' ', unpack=True)
        Index3, Thread3, Time3 , BestFitnessValue3 = np.loadtxt( nameoffile3 , delimiter=' ', unpack=True)
        Index4, Thread4, Time4 , BestFitnessValue4 = np.loadtxt( nameoffile4 , delimiter=' ', unpack=True)
        Index5, Thread5, Time5 , BestFitnessValue5 = np.loadtxt( nameoffile5 , delimiter=' ', unpack=True)
        Index6, Thread6, Time6 , BestFitnessValue6 = np.loadtxt( nameoffile6 , delimiter=' ', unpack=True)
        Index7, Thread7, Time7 , BestFitnessValue7 = np.loadtxt( nameoffile7 , delimiter=' ', unpack=True) 
        #Sorting(oIndex1, oThread1, oTime1, oBestFitnessValue1)
        #Sorting(oIndex2, oThread2, oTime2, oBestFitnessValue2)
        #Sorting(oIndex3, oThread3, oTime3, oBestFitnessValue3)
        ...
        PlottingIndex1, PlottingThread1, PlottingTime1, PlottingBestFitnessValue1, PlottingDeviation1, Deviations1 = Prepare(Index1, Thread1, Time1, BestFitnessValue1) 
        PlottingIndex2, PlottingThread2, PlottingTime2, PlottingBestFitnessValue2, PlottingDeviation2, Deviations2 = Prepare(Index2, Thread2, Time2, BestFitnessValue2)
        PlottingIndex3, PlottingThread3, PlottingTime3, PlottingBestFitnessValue3, PlottingDeviation3, Deviations3 = Prepare(Index3, Thread3, Time3, BestFitnessValue3)
        PlottingIndex4, PlottingThread4, PlottingTime4, PlottingBestFitnessValue4, PlottingDeviation4, Deviations4 = Prepare(Index4, Thread4, Time4, BestFitnessValue4)
        PlottingIndex5, PlottingThread5, PlottingTime5, PlottingBestFitnessValue5, PlottingDeviation5, Deviations5 = Prepare(Index5, Thread5, Time5, BestFitnessValue5)
        PlottingIndex6, PlottingThread6, PlottingTime6, PlottingBestFitnessValue6, PlottingDeviation6, Deviations6 = Prepare(Index6, Thread6, Time6, BestFitnessValue6)
        PlottingIndex7, PlottingThread7, PlottingTime7, PlottingBestFitnessValue7, PlottingDeviation7, Deviations7 = Prepare(Index7, Thread7, Time7, BestFitnessValue7)
