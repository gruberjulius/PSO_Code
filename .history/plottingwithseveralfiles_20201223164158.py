...
def main():
    ...
    if placetogo == 1:
        ...
        plotfitnesswith7inputfiles( PlottingIndex1, PlottingIndex2, PlottingIndex3, PlottingIndex4, PlottingIndex5, PlottingIndex6, PlottingIndex7, 
            PlottingThread1, PlottingThread2, PlottingThread3, PlottingThread4, PlottingThread5, PlottingThread6, PlottingThread7, 
            PlottingTime1, PlottingTime2, PlottingTime3, PlottingTime4, PlottingTime5, PlottingTime6, PlottingTime7, PlottingBestFitnessValue1, 
            PlottingDeviation1, PlottingDeviation2, PlottingDeviation1, PlottingDeviation4, PlottingDeviation5,PlottingDeviation5, PlottingDeviation6, 
            PlottingDeviation7, PlottingBestFitnessValue2, PlottingBestFitnessValue3, PlottingBestFitnessValue4, PlottingBestFitnessValue5, PlottingBestFitnessValue6, 
            PlottingBestFitnessValue7, storagelocation, titleofplot, startindex, endindex, xlabel, ylabel)
