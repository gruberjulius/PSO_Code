...
#define OUTPUT_FILE "results/times_papso_pre_2" //folder and start of filename
...
/*
    ...
    if(rank == 0){
        ...
        moether.setFitnessFunction( [s_case](auto moe) -> double {
            std::vector<variable_datatype> x = moe.genotype;
        ...
        switch(s_case) {
            ...
            case 1: 
                ...
                break;
            case 2: 
                result = holdertable(x);
                break;
            case 3: 
                result = Rastrigin_f(x);
                break;
            case 4: 
                result = Schwefel2_f(x);
                break;
            case 5:
                result = VERY_Complicated(x);
                break;
            default:
...
*/    
    ...
    moe::ParticleSwarmPA_prec_vel_2<variable_datatype> PAPSOmoether( moe::PSParameters<variable_datatype>() 
    ...
    PAPSOmoether.setFitnessFunction( [s_case](auto moe) -> double 
        ...
        switch(s_case) {
            ...
            case 1: 
                ...
                break;
            case 2: 
            //    result = holdertable(x);//holdertable doesn't have vector overload...
                result = 0;
                break;
            case 3: 
                result = Rastrigin_f(x);
    ...
    if (rank == 0){ //Master processor
        ...
        PAPSOmoether.run( iterations, dim);
