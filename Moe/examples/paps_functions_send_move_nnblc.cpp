...
#define OUTPUT_FILE "results/times_papso_send_nnblc"
...
*/
    ...
    moe::ParticleSwarmPA_send_move_nnblc<variable_datatype> PAPSOmoether( moe::PSParameters<variable_datatype>()
