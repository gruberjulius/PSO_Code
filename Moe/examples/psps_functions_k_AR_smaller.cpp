...
#define OUTPUT_FILE "results/times_pspso_k_AR_smaller" //folder and start of filename
                                          //end always #iter_#threads_#seq/master


using variable_datatype = float;
...
*/
    ...
    moe::ParticleSwarmPS_k_aR_smaller<variable_datatype> PSPSOmoether( moe::PSParameters<variable_datatype>()
