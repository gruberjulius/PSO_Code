...
#define OUTPUT_FILE "results/times_papso_send_termcrit"
...
*/
    ...
    moe::ParticleSwarmPA_send_move_termcrit<variable_datatype> PAPSOmoether( moe::PSParameters<variable_datatype>()
