...
#define OUTPUT_FILE "results/times_pspso_k_test" //folder and start of filename
...
*/
    ...
    moe::ParticleSwarmPS_k_t<variable_datatype> PSPSOmoether( moe::PSParameters<variable_datatype>() 
