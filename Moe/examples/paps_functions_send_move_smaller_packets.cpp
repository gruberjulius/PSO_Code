...
#define OUTPUT_FILE "results/times_papso_send_smaller_packets"
...
*/
    ...
    moe::ParticleSwarmPA_send_move_smaller_packets<variable_datatype> PAPSOmoether( moe::PSParameters<variable_datatype>()
