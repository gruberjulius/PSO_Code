...
#define OUTPUT_FILE "results/times_papso" //folder and start of filename
...
*/  
    ...
    moe::ParticleSwarmPA<variable_datatype> PAPSOmoether( moe::PSParameters<variable_datatype>() 
