...
#define OUTPUT_FILE "results/times_pspso_kristof" //folder and start of filename
...
*/
    ...
    moe::ParticleSwarmPS_k<variable_datatype> PSPSOmoether( moe::PSParameters<variable_datatype>() 
