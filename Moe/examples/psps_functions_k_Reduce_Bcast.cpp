...
#define OUTPUT_FILE "results/times_pspso_k_Reduce_Bcast" //folder and start of filename
...
*/
    ...
    moe::ParticleSwarmPS_k_RB<variable_datatype> PSPSOmoether( moe::PSParameters<variable_datatype>() 
