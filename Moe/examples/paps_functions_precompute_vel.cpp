...
#define OUTPUT_FILE "results/times_papso_pre" //folder and start of filename
...
*/    
    ...
    moe::ParticleSwarmPA_prec_vel<variable_datatype> PAPSOmoether( moe::PSParameters<variable_datatype>() 
