...
#define OUTPUT_FILE "results/times_papso_send_part_unroll"
...
*/
    ...
    moe::ParticleSwarmPA_send_move_part_unroll<variable_datatype> PAPSOmoether( moe::PSParameters<variable_datatype>()
