...
class ParticleSwarmPA_send_move : public NumericAlgorithm<GenotypeType>
{
    public:
        ParticleSwarmPA_send_move( unsigned int _moesPerGen, float _weight, float _coef1, float _coef2, unsigned int _dimensions = 1, std::vector<GenotypeType> _range = { std::numeric_limits<GenotypeType>::lowest() , std::numeric_limits<GenotypeType>::max() });
        ParticleSwarmPA_send_move( const PSParameters<GenotypeType>& _parameters );
...
template <typename GenotypeType>
ParticleSwarmPA_send_move<GenotypeType>::ParticleSwarmPA_send_move( unsigned int _moesPerGen, float _weight, float _coef1, float _coef2, unsigned int _dimensions, std::vector<GenotypeType> _range )
...
template <typename GenotypeType>
ParticleSwarmPA_send_move<GenotypeType>::ParticleSwarmPA_send_move( const PSParameters<GenotypeType>& _parameters )
:ParticleSwarmPA_send_move<GenotypeType>( _parameters.moesPerGen, _parameters.inertia, _parameters.coef1, _parameters.coef2, _parameters.dimensions, _parameters.range )
{

}

template <typename GenotypeType>
void ParticleSwarmPA_send_move<GenotypeType>::init( unsigned int _iterations )
{
...
template <typename GenotypeType>
void ParticleSwarmPA_send_move<GenotypeType>::run( unsigned int _iterations){std::cout<<"The wrong \" run \" function has been called in ParticleSwarmPA_send_move.cpp"<<std::endl;}
template <typename GenotypeType>
void ParticleSwarmPA_send_move<GenotypeType>::run( unsigned int _iterations, int& argc, char * argv[])
{
    int rank, numproces;
