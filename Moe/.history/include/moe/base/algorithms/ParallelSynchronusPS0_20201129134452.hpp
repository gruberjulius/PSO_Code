...
class ParticleSwarmPS : public NumericAlgorithm<GenotypeType>
{
    public:
        ...
        void PSrun( unsigned int _iterations ) override;
...
template <typename GenotypeType>
ParticleSwarm<GenotypeType>::ParticleSwarmPS( unsigned int _moesPerGen, float _weight, float _coef1, float _coef2, unsigned int _dimensions, std::vector<GenotypeType> _range )
...
template <typename GenotypeType>
ParticleSwarm<GenotypeType>::ParticleSwarmPS( const PSParameters<GenotypeType>& _parameters )
...
template <typename GenotypeType>
void ParticleSwarm<GenotypeType>::PSrun( unsigned int _iterations )
{   
    ...
    for( unsigned int i = 0; i < m_iterations; i++ )
    {
        ...
        int res = MPI_Init(&argc, &argv); //delcaring a res function like here: https://riptutorial.com/de/mpi/example/8638/init---finalisieren
        ...
        res = MPI_Finalize(); //declaring a res function like here https://riptutorial.com/de/mpi/example/8638/init---finalisieren

        if( max_of_iter > Algorithm<GenotypeType>::m_bestMoe.fitness ) 
                            Algorithm<GenotypeType>::m_bestMoe = max_of_iter;
