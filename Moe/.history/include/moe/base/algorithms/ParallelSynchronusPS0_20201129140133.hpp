...
{   
    ...
    for( unsigned int i = 0; i < m_iterations; i++ )
    {
        ...
        //MPI_Init(&argc, &argv); //delcaring a res function like here: https://riptutorial.com/de/mpi/example/8638/init---finalisieren
        //MPI_Init();//it is not required to parse anything
        //MPI_init(&argc,&argv)
        int MPI_Init(int *argc, char ***argv); //got error with this version it is fixed
