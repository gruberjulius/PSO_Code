...
template <typename GenotypeType>
ParticleSwarmPS<GenotypeType>::ParticleSwarm( unsigned int _moesPerGen, float _weight, float _coef1, float _coef2, unsigned int _dimensions, std::vector<GenotypeType> _range )
...
template <typename GenotypeType>
ParticleSwarmPS<GenotypeType>::ParticleSwarm( const PSParameters<GenotypeType>& _parameters )
