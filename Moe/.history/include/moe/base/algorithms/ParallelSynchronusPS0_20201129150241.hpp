...
template <typename GenotypeType>
void ParticleSwarmPS<GenotypeType>::run( unsigned int _iterations){std::cout<<"The wrong \" run \" function has been called in ParticleSwarmPA.cpp"<<std::endl;}
template <typename GenotypeType>
void ParticleSwarmPS<GenotypeType>::run( unsigned int _iterations, int& argc, char * argv[])
{ 
